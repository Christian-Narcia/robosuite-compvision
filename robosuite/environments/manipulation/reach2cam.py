...
class Reach2Cam(ManipulationEnv):
    """
...
def __init__(
    ...
    ignore_done=False,
    hard_reset=True,
    camera_names=["agentview"],  # Add a second camera
    camera_heights=[256, 256],  # Define height for both cameras
    camera_widths=[256, 256],   # Define width for both cameras
    camera_depths=[False, False],  # Define depth for both cameras (RGB)
    camera_segmentations=None,  # {None, instance, class, element}
    renderer="mujoco",
    renderer_config=None,
    target_pos=None,
):
    # Update camera parameters for two cameras
