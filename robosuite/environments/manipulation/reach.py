...
class Reach(ManipulationEnv):
    ...
    def reward(self, action=None):
        ...
        # use a shaping reward
            ...
            # gripper_site_pos = self.sim.data.body_xpos[self.robots[0].eef_body_id['right']]
            # gripper_site_pos = self.robots[0]._hand_pos['right']
            gripper_site_pos = self.sim.data.site_xpos[self.robots[0].eef_site_id['right']]
            # gripper_site_pos = self.sim.data.site_xpos[self.robots[0]._hand_pos['right']]
            # reaching reward
    ...
    def _load_model(self):
        ...
        # print("this is target pos",target_pos)
        # print("This is join ", "pos", " ".join([str(num) for num in target_pos]))
    ...
    def _check_success(self):
        ...
        """
        #########################################FIXX
        # print(self.robots[0].eef_site_id['right'])
        # print(self.sim.data.site_xpos)
        # print(self.sim.data.site_xpos[self.robots[0].eef_site_id])
        # exit()
        # print(":::::",self.sim.data.site_xpos[self.robots[0].keys])
        # print(":::::333", self.robots[0].eef_site_id)
        # print(":::::333", self.robots[0]._hand_pos)
        # print(":::::444", dir(self.robots[0]._hand_pose))
        # print("====", dir(self.robots[0]._hand_pose.values))
        # print(":::::", self.robots[0]._hand_pose['values'])
        # print("------",self.robots[0].eef_site_id['right'])
        gripper_site_pos = self.sim.data.site_xpos[self.robots[0].eef_site_id['right']]
        # print("1111",gripper_site_pos)
        # gripper_site_pos = self.robots[0]._hand_pos['right']
        # print(gripper_site_pos)
        # gripper_site_pos = self.sim.data.body_xpos[self.robots[0].eef_body_id]
        # gripper_site_pos = False
        target_pos = self.sim.data.body_xpos[self.target_body_id]
