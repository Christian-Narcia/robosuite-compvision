...
class reachImgSimplified(ManipulationEnv):
    """
    ...
    def reward(self, action=None):
        ...
        # use a shaping reward
            ...
            # reaching reward
            gripper_site_pos = self.sim.data.site_xpos[self.robots[0].eef_site_id['right']]
            # print("Gripper location:", gripper_site_pos)
            # print("Gripper location:", gripper_site_pos)
            
            # distance based reaching reward
            target_pos = self.sim.data.body_xpos[self.target_body_id]
            dist = np.linalg.norm(gripper_site_pos - target_pos)


            # Ball is on the right side
            # if gripper_site_pos[1] > 0.1 and target_pos[1] == 0.3:
            #     reaching_reward = .1
            # # Ball is on the left side
            # elif gripper_site_pos[1] < -0.1 and target_pos[1] == -0.3:
            #     reaching_reward = .1
            # else:
            #     reaching_reward = 0
            # reward = reaching_reward
    ...
    def _load_model(self):
        ...
        #     print("Setting Position: ", target_pos)
        # else:
    ...
    #     target_pos = self.sim.data.body_xpos[self.target_body_id]
    #     print("ball location:", target_pos)
    ...
    def _check_success(self):
        ...
        # print("Gripper location on start", gripper_site_pos)
        # exit()
