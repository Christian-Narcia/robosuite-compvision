...
class UR5ev2(ManipulatorModel):
    """
    UR5ev2 is a sleek and elegant new robot created by Universal Robots
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/ur5ev2/robot.xml"), idn=idn)
